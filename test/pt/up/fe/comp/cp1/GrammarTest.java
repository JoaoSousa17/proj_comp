...
public class GrammarTest {
   ...
   /*@Test
    ...
    public void testClassWithoutExtends() {
        TestUtils.parseVerbose("class Foo {}", "program");
    }

    @Test
    public void testClassWithMultipleFields() {
        TestUtils.parseVerbose("class Foo {int a; boolean b; int[] c; Bar d;}", "program");
    }

    @Test
    public void testPublicMethod() {
        TestUtils.parseVerbose("class Test { public int foo() {return 0;} }", "program");
    }

    @Test
    public void testMethodWithMultipleParams() {
        TestUtils.parseVerbose("class Test { int foo(int a, boolean b, int[] c) {return a;} }", "program");
    }

    @Test
    public void testStmtExpression() {
        TestUtils.parseVerbose("a;", STATEMENT);
    }

    @Test
    public void testStmtReturn() {
        TestUtils.parseVerbose("return a;", STATEMENT);
    }

    @Test
    public void testExprBinaryOperationsPrecedence() {
        TestUtils.parseVerbose("1 + 2 * 3", EXPRESSION);
    }

    @Test
    public void testExprBinaryOperationsWithParentheses() {
        TestUtils.parseVerbose("(1 + 2) * 3", EXPRESSION);
    }

    @Test
    public void testExprArrayInitializerEmpty() {
        TestUtils.parseVerbose("[]", EXPRESSION);
    }

    @Test
    public void testExprArrayInitializerSingleElement() {
        TestUtils.parseVerbose("[10]", EXPRESSION);
    }

    @Test
    public void testExprMethodCallNoArgs() {
        TestUtils.parseVerbose("obj.foo()", EXPRESSION);  // receiver.method()
    }

    @Test
    public void testExprMethodCallSingleArg() {
        TestUtils.parseVerbose("obj.foo(10)", EXPRESSION);
    }

    @Test
    public void testExprMethodCallWithArrayAccess() {
        TestUtils.parseVerbose("obj.foo(a[10])", EXPRESSION);
    }

    @Test
    public void testExprMethodCallMultipleArgs() {
        TestUtils.parseVerbose("obj.foo(10, true, bar)", EXPRESSION);
    }

    @Test
    public void testExprMethodCallWithMethodCall() {
        TestUtils.parseVerbose("obj.foo(bar.baz())", EXPRESSION);  // Note chained calls need receivers
    }

    @Test
    public void testExprComplexNested() {
        TestUtils.parseVerbose("new Foo().bar(a[10] + (b * c.length))", EXPRESSION);
    }

    @Test
    public void testProgramWithImportAndClass() {
        TestUtils.parseVerbose("import foo.bar;\nclass Foo {}", "program");
    }

    @Test
    public void testProgramWithMultipleImports() {
        TestUtils.parseVerbose("import foo.bar;\nimport another.pkg;\nclass Foo {}", "program");
    }

    @Test
    public void testVarDeclWithArrayType() {
        TestUtils.parseVerbose("class Test { int[] a; }", "program");
    }


    @Test
    public void testVarDeclWithVarargsType() {
        TestUtils.parseVerbose("class Test { int... a; }", "program");
    }

    @Test
    public void testVarDeclWithCustomType() {
        TestUtils.parseVerbose("class Test { Foo a; }", "program");
    }

    @Test
    public void testMainMethodWithBody() {
        TestUtils.parseVerbose("static void main(String[] args) {int a; a=10;}", MAIN_METHOD);
    }

    @Test
    public void testMethodWithArrayReturnType() {
        TestUtils.parseVerbose("int[] foo() {return [10,20];}", INSTANCE_METHOD);
    }

    @Test
    public void testMethodWithVarargsReturnType() {
        TestUtils.parseVerbose("int... foo() {return [10,20];}", INSTANCE_METHOD);
    }
