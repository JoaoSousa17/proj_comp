...
public class SemanticAnalysisTest {
    ...
    public void NestedBinary() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/NestedBinary.jmm"));
        TestUtils.noErrors(result);
        System.out.println(result.getReports());
    }
    @Test
    public void ArrayIndexNotBoolean() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ArrayIndexNotBoolean.jmm"));
        TestUtils.noErrors(result);
        System.out.println(result.getReports());
    }

    @Test
    public void ArrayIndexString() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/ArrayIndexString.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }

    @Test
    public void BooleanInWhileCondition() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/BooleanInWhileCondition.jmm"));
        TestUtils.noErrors(result);
        System.out.println(result.getReports());
    }

    @Test
    public void UsingBooleanAsInteger() {
        var result = TestUtils
                .analyse(SpecsIo.getResource("pt/up/fe/comp/cp1/semanticanalysis/UsingBooleanAsInteger.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
}
